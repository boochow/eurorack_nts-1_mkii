...
# C++ sources
UCXXSRC = $(SRCDIR)/unit.cc $(SRCDIR)/digital_oscillator.cc $(SRCDIR)/resources.cc $(BRAIDSDIR)/quantizer.cc $(SRCDIR)/macro_oscillator.cc $(BRAIDSDIR)/analog_oscillator.cc $(STMLIBDIR)/utils/random.cc
